...
Data stewardship is een belangrijk deel van het onderzoeksproces, zeker als het aankomt op veiligheid, transparantie, en samenwerking. Data op een gecontroleerde manier ordenen maakt het mogelijk voor grotere groepen om te werken met de data, in plaats van maar één individu die slechte organisatie heeft maar weet waar de dingen zijn die hij/zij nodig heeft. Ook is het belangrijk dat privégegevens niet verder strekken dan de bedoeling is; hiervoor is het ook cruciaal om een systematische aanpak te hanteren.
